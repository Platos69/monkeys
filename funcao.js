...
//EXERCICIO 2: Faça uma função que receba um único valor representado em segundos. Essa função deverá convertê-lo para horas, minutos e segundos. 
...
//     return `Horas${horas} minutos ${minutos} segundos ${seconds}`
// }
